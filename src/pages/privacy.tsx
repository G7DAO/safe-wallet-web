...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Game7 Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <p>
      When visiting our website or using {'Game7 Safe'}, we may collect and process personal data. The data will be
    ...
    <p>
      4.2.2 For general operational analysis of the {'Game7 Safe'} interface, monitoring transaction origins and
    ...
    <p>
      In addition, we may take a recording of you while testing {'Game7 Safe'} for internal and external use. The
    ...
    <p>
      We enable the user to unlock the {'Game7 Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Game7 Safe`}. For
