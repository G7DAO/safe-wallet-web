...
const ExternalCookiePolicy = () => (
  <div>
    ...
    <p>
      ...
      <Link href="https://safe.game7.io" passHref legacyBehavior>
        <MUILink>https://safe.game7.io</MUILink>
      </Link>
    ...
    <p>
      We may also use other services, such as Google Analytics or other third-party cookies, to assist with analyzing
      performance on our website. As part of providing these services, these service providers may use cookies and the
      technologies described below to collect and store information about your device, such as time of visit, pages
      visited, time spent on each page of our website, links clicked and conversion information, IP address, browser,
      mobile network information, and type of operating system used.
    </p>
